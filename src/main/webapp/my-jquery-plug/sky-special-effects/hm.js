(function () {
    var h = {}, mt = {}, c = {
        id: "42c1003b57813e1d286a824118f444cf",
        dm: ["landian.la"],
    ...
    mt.i = {};
    mt.i.za = /msie (\d+\.\d+)/i.test(navigator.userAgent);
    mt.i.xa = /msie (\d+\.\d+)/i.test(navigator.userAgent) ? document.documentMode || +RegExp.$1 : q;
    ...
    mt.i.Ba = (window.screen.width || 0) + "x" + (window.screen.height || 0);
    mt.i.colorDepth = window.screen.colorDepth || 0;
    mt.cookie = {};
    mt.cookie.set = function (a, d, e) {
        var f;
        e.G && (f = new Date, f.setTime(f.getTime() + e.G));
        document.cookie = a + "=" + d + (e.domain ? "; domain=" + e.domain : "") + (e.path ? "; path=" + e.path : "") + (f ? "; expires=" + f.toGMTString() : "") + (e.Za ? "; secure" : "")
    };
    ...
    (mt.p.X = function () {
        function a() {
            if (!a.z) {
                a.z = r;
                for (var d = 0, e = f.length; d < e; d++) f[d]()
            }
        }
        ...
        (function () {
            if (!e) if (e = r, "complete" === document.readyState) a.z = r; else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
                k, u), window.addEventListener("load", a, u); else if (document.attachEvent) {
                document.attachEvent("onreadystatechange", k);
                window.attachEvent("onload", a);
                var f = u;
                try {
                    f = window.frameElement == s
                } catch (n) {
                }
    ...
    mt.event.c = function (a, d, e) {
        a.attachEvent ? a.attachEvent("on" + d, function (d) {
            e.call(a, d)
        }) : a.addEventListener && a.addEventListener(d, e, u)
    };
            ...
            switch (typeof f) {
                ...
                default:
                    ...
                    if (f instanceof Array) {
                        var e = ["["], m = f.length, n, p, g;
                        for (p = 0; p < m; p++) switch (g = f[p], typeof g) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
                    ...
                    if (f instanceof Date) return '"' + f.getFullYear() + "-" + d(f.getMonth() + 1) + "-" + d(f.getDate()) + "T" + d(f.getHours()) + ":" + d(f.getMinutes()) + ":" + d(f.getSeconds()) + '"';
                    n = ["{"];
                    p = mt.j.stringify;
                    for (m in f) if (Object.prototype.hasOwnProperty.call(f, m)) switch (g =
                        f[m], typeof g) {
                        case "undefined":
                        case "unknown":
                        case "function":
    ...
    mt.localStorage.set = function (a, d, e) {
        var f = new Date;
        f.setTime(f.getTime() + e || 31536E6);
        try {
            window.localStorage ? (d = f.getTime() + "|" + d, window.localStorage.setItem(a, d)) : mt.localStorage.B() && (mt.localStorage.g.expires = f.toUTCString(), mt.localStorage.g.load(document.location.hostname), mt.localStorage.g.setAttribute(a, d), mt.localStorage.g.save(document.location.hostname))
        } catch (k) {
        }
    };
    mt.localStorage.get = function (a) {
        if (window.localStorage) {
            if (a = window.localStorage.getItem(a)) {
                var d = a.indexOf("|"), e = a.substring(0, d) - 0;
                if (e && e > (new Date).getTime()) return a.substring(d + 1)
            }
    ...
    mt.Y.log = function (a, d) {
        var e = new Image, f = "mini_tangram_log_" + Math.floor(2147483648 * Math.random()).toString(36);
        window[f] = e;
    ...
    mt.O.Ra = function (a, d, e, f, k) {
        return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + a + '" width="' + e + '" height="' + f + '"><param name="movie" value="' + d + '" /><param name="flashvars" value="' + (k || "") + '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + a + '" width="' + e + '" height="' + f + '" src="' + d + '" flashvars="' + (k || "") + '" allowscriptaccess="always" /></object>'
    };
    mt.url = {};
    ...
    (function () {
        function a() {
            for (var a = u, e = document.getElementsByTagName("script"), f = e.length, f = 100 < f ? 100 : f, k = 0; k < f; k++) {
                var m = e[k].src;
    ...
    (function () {
        var a = {
            m: {}, c: function (a, e) {
                ...
                this.m[a] = this.m[a] || [];
                for (var f = this.m[a].length, k = 0; k < f; k++) this.m[a][k](e)
            }
        };
        return h.F = a
    })();
    (function () {
        function a(a, f) {
            ...
            k.charset = "utf-8";
            d.d(f, "Function") && (k.readyState ? k.onreadystatechange = function () {
                if ("loaded" === k.readyState || "complete" === k.readyState) k.onreadystatechange = s, f()
            } : k.onload = function () {
                f()
            });
            k.src = a;
    ...
    (function () {
        ...
        function d() {
            ...
            if ((!n || !g) && p && b) v = r, l = +new Date; else if (n && g && (!p || !b)) v = u, t += +new Date - l;
            n = p;
            g = b;
            z = setTimeout(d, 100)
        }
        ...
        function e(b) {
            var a = document, l = "";
            if (b in a) l = b; else for (var t = ["webkit", "ms", "moz", "o"], d = 0; d < t.length; d++) {
                var f = t[d] + b.charAt(0).toUpperCase() + b.slice(1);
                if (f in a) {
                    l =
                        f;
                    break
        ...
        function f(a) {
            if (!("focus" == a.type || "blur" == a.type) || !(a.target && a.target != window)) b = "focus" == a.type || "focusin" == a.type ? r : u, d()
        }

        var k = mt.event, m = h.F, n = r, p = r, g = r, b = r, w = +new Date, l = w, t = 0, v = r,
            x = e("visibilityState"), y = e("hidden"), z;
        d();
        (function () {
            ...
            "object" == typeof document.onfocusin ? (k.c(document, "focusin", f), k.c(document, "focusout", f)) : (k.c(window, "focus", f),
                k.c(window, "blur", f))
        })();
        h.D = {
            oa: function () {
    ...
    (function () {
        var a = mt.lang, d = h.C, e = h.load, f = {
            ya: function (f) {
                if ((window._dxt === q || a.d(window._dxt, "Array")) && "undefined" !== typeof h.b) {
                    var m = h.b.H();
                    e([d.protocol, "//datax.baidu.com/x.js?si=", c.id, "&dm=", encodeURIComponent(m)].join(""), f)
                }
            }, Ha: function (d) {
    ...
    (function () {
        function a(b, a, l, t) {
            if (!(b === q || a === q || t === q)) {
                if ("" === b) return [a, l, t].join("*");
                b = String(b).split("!");
                for (var d, f = u, e = 0; e < b.length; e++) if (d = b[e].split("*"), String(a) === d[0]) {
                    d[1] = l;
                    d[2] = t;
                    b[e] = d.join("*");
                    f = r;
        ...
        function d(b) {
            for (var a in b) if ({}.hasOwnProperty.call(b, a)) {
                var l = b[a];
                f.d(l, "Object") || f.d(l, "Array") ? d(l) : b[a] = String(l)
            }
        }
        ...
        var f =
            mt.lang, k = mt.j, m = h.C, n = h.F, p = h.ea, g = {
            r: [], A: 0, U: u, l: {P: "", page: ""}, init: function () {
                g.e = 0;
                n.c("pv-b", function () {
                    g.fa();
                    g.ha()
                ...
                var b = window._hmt || [];
                if (!b || f.d(b, "Array")) window._hmt = {
                    id: c.id, cmd: {}, push: function () {
                        for (var b = window._hmt, a = 0; a < arguments.length; a++) {
                            var d =
                                arguments[a];
                            f.d(d, "Array") && (b.cmd[b.id].push(d), "_setAccount" === d[0] && (1 < d.length && /^[0-9a-f]{32}$/.test(d[1])) && (d = d[1], b.id = d, b.cmd[d] = b.cmd[d] || []))
                        }
                    }
                }, window._hmt.cmd[c.id] = [], window._hmt.push.apply(window._hmt, b)
            }, ha: function () {
                var b = window._hmt;
                if (b && b.cmd && b.cmd[c.id]) for (var a = b.cmd[c.id], l = /^_track(Event|MobConv|Order|RTEvent)$/, d = 0, f = a.length; d < f; d++) {
                    var e = a[d];
                    l.test(e[0]) ? g.r.push(e) : g.M(e)
                }
                b.cmd[c.id] = {push: g.M}
            }, ia: function () {
                ...
                var a = b[0];
                if (g.hasOwnProperty(a) && f.d(g[a], "Function")) g[a](b)
            }, _setAccount: function (b) {
                1 < b.length && /^[0-9a-f]{32}$/.test(b[1]) && (g.e |= 1)
            }, _setAutoPageview: function (b) {
                if (1 < b.length && (b = b[1], u === b || r === b)) g.e |= 2, h.b.T = b
                ...
                2 < b.length && (g.e |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = e(b[1]) + "*" + e(b[2]) + (b[3] ? "*" + e(b[3]) : "") + (b[4] ? "*" + e(b[4]) : ""), h.b.h())
            }, _setCustomVar: function (b) {
                if (!(4 > b.length)) {
                    var a = b[1], l = b[4] || 3;
                    if (0 < a && 6 > a && 0 < l && 4 > l) {
                        g.A++;
                        for (var d = (h.b.a.cv || "*").split("!"), f = d.length; f < a - 1; f++) d.push("*");
                        d[a - 1] = l + "*" + e(b[2]) + "*" + e(b[3]);
                        h.b.a.cv = d.join("!");
                        b = h.b.a.cv.replace(/[^1](\*[^!]*){2}/g, "*").replace(/((^|!)\*)+$/g, "");
                        "" !== b ? h.b.setData("Hm_cv_" +
                            c.id, encodeURIComponent(b), c.age) : h.b.Aa("Hm_cv_" + c.id)
                    }
                }
                ...
                if (!(3 > b.length)) {
                    ...
                    b = e(b[2]);
                    if (d !== q && b !== q) {
                        var l = decodeURIComponent(h.b.getData("Hm_ct_" + c.id) || ""), l = a(l, d, 1, b);
                        h.b.setData("Hm_ct_" + c.id, encodeURIComponent(l), c.age)
                    }
                }
                ...
                b = b[1];
                f.d(b, "Object") && (d(b), g.e |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = k.stringify(b), h.b.h())
                ...
                b = b[1];
                f.d(b, "Object") && (d(b), b = k.stringify(b), 512 >= encodeURIComponent(b).length &&
                (g.e |= 64, h.b.a.rt = b))
                ...
                if (f.d(b, "Object")) {
                    ...
                    if (900 >= l) a.call(this, b); else for (var l = Math.ceil(l / 900), e = "block|" + Math.round(Math.random() * m.L).toString(16) + "|" + l + "|", v = [], x = 0; x < l; x++) v.push(x), v.push(b.substring(900 * x, 900 * x + 900)), a.call(this, e + v.join("|")), v = []
                }
    ...
    (function () {
        function a() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = r, this.a = {}, this.T = r, this.I = u, this.init())
        }

        var d = mt.url, e = mt.Y, f = mt.O, k = mt.lang, m = mt.cookie, n = mt.i, p = mt.localStorage,
            g = mt.sessionStorage, b = h.C, w = h.F;
        a.prototype = {
            J: function (b, a) {
                b = "." + b.replace(/:\d+/, "");
                a = "." + a.replace(/:\d+/, "");
                ...
                for (var a = 0; a < c.dm.length; a++) if (-1 <
                    ...
                    var f = d.S(b);
                    if (f && this.J(f, c.dm[a])) return r
                }
                return u
            }, H: function () {
                for (var b = document.location.hostname, a = 0, d = c.dm.length; a < d; a++) if (this.J(b, c.dm[a])) return c.dm[a].replace(/(:\d+)?[\/\?#].*/, "");
                return b
            }, R: function () {
                ...
                d = this.pa();
                a = 4 !== d ? 1 : 0;
                if (f = this.getData("Hm_lvt_" + c.id)) {
                    e = f.split(",");
                    for (g = e.length - 1; 0 <= g; g--) 13 === e[g].length && (e[g] = "" + Math.round(e[g] / 1E3));
                    for (; 2592E3 < b.k - e[0];) e.shift();
                    g = 4 > e.length ? 2 : 3;
                    for (1 === a && e.push(b.k); 4 < e.length;) e.shift();
                    f = e.join(",");
                    e = e[e.length - 1]
                } else f = b.k, e = "", g = 1;
            ...
            Ga: function () {
                ...
                this.a.cw = d.f(a, b.ta) || d.f(a,
                    b.Ma) || "";
                this.a.ci = d.f(a, b.ra) || d.f(a, b.Ja) || "";
                this.a.cf = d.f(a, b.wa) || d.f(a, b.La) || "";
                this.a.cu = d.f(a, b.sa) || d.f(a, b.Ia) || ""
            }, init: function () {
                try {
                    this.Ga(), 0 === this.a.nv ? this.Da() : this.N(".*"), h.b = this, this.da(), w.s("pv-b"), this.Ca()
                } catch (a) {
                    var d = [];
                    d.push("si=" + c.id);
                ...
                if (d) for (var d = d.split(","), f = function (d) {
                    e.log(b.K + "//" + decodeURIComponent(d), function (b) {
                        a.N(b)
                    })
                }, k = 0, y = d.length; k < y; k++) f(d[k])
            }
        };
        return new a
    })();
    (function () {
        var a = mt.p, d = mt.event, e = mt.url, f = mt.j;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                ...
                var p = function () {
                    ...
                    d = s;
                    if ("www.baidu.com" === p[2] || "m.baidu.com" === p[2]) v = e.f(a, "qid"), d = e.f(a, "click_t");
                    a = v;
                    g.qid = a != s ? a : "";
    ...
    (function () {
        var a = mt.i, d = mt.lang, e = mt.event, f = mt.j;
        if ("undefined" !== typeof h.b && (c.med || (!a.za || 7 < a.xa) && c.cvcc)) {
            var k, m, n, p, g = function (a) {
                ...
                if (b) {
                    ...
                    n.test(g) ? (e.sn = "mediate",
                        e.snv = g) : d.d(l, "String") && n.test(l) && (e.sn = "wrap", e.snv = l);
                    e.id = m
                }
                h.b.a.et = 86;
            ...
            if (c.med) m = "/zoosnet", k = "swt", n = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, p = {
                ...
                p = {
                    click: function () {
                        for (var a = [], b = g(document.getElementsByTagName("a")), b = [].concat.apply(b, g(document.getElementsByTagName("area"))), b = [].concat.apply(b, g(document.getElementsByTagName("img"))), d, e, f, k = 0, m = b.length; k < m; k++) d = b[k], n !== q ? (e = d.getAttribute("onclick"), f = d.getAttribute("href"), l ? (d = d.getAttribute("id"), (n.test(e) || n.test(f) || l.test(d)) &&
                        a.push(b[k])) : (n.test(e) || n.test(f)) && a.push(b[k])) : l !== q && (d = d.getAttribute("id"), l.test(d) && a.push(b[k]));
                        return a
                    }
                }
            }
            if ("undefined" !== typeof p && "undefined" !== typeof n) {
                ...
                m += /\/$/.test(m) ? "" : "/";
                var v = function (a, b) {
                    if (t === b) return w(m + a, b), u;
                    if (d.d(b, "Array") || d.d(b, "NodeList")) for (var e = 0, f = b.length; e < f; e++) if (t === b[e]) return w(m + a + "/" + (e + 1), b[e]), u
                };
                e.c(document, "mousedown", function (a) {
                    ...
                    for (b(p, function (a, b) {
                        e[a] = d.d(b, "Function") ? b() : document.getElementById(b)
                         ...
                         t !== document && b(e, v) !== u;) t = t.parentNode
                })
            }
        }
    })();
    (function () {
        var a = mt.p, d = mt.lang, e = mt.event, f = mt.j;
        if ("undefined" !== typeof h.b && d.d(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var k = {
                $: function () {
                    for (var d = c.cvcf.length, f, p = 0; p < d; p++) (f = a.la(decodeURIComponent(c.cvcf[p]))) && e.c(f, "click", k.ga())
                }, ga: function () {
                    return function () {
                        h.b.a.et = 86;
                        var a = {n: "form", t: "clk"};
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.b) {
            var e = +new Date, f = {n: "anti", sb: 0, kb: 0, clk: 0}, k = function () {
                h.b.a.et = 86;
